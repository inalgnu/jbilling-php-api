...
class ContactWS
{
    public $address1;                // First line for the address.
    public $address2;                // Second line for the address.
    public $city;                    // City of this contact.
    public $countryCode;             // Country code for this contact (Appendix A contains a list of acceptable country codes).
    public $createDate;              // Date this contact record was first created.
    ...
    public $email;                   // E-Mail address of this contact.
    public $faxAreaCode;             // Area Code for the fax number, if any.
    public $faxCountryCode;          // Country Code for the fax number, if any.
    public $faxNumber;               // Fax number.
    public $firstName;               // First name for the contact.
    public $id;                      // Unique identifier of this contact.
    public $include;                 // “1”, if this contact is marked as included in notifications.
    public $initial;                 // Middle name initials, if any.
    public $lastName;                // Contact's surname.
    public $organizationName;        // Name of the organization the contact belongs to.
    public $phoneAreaCode;           // Phone number Area Code.
    public $phoneCountryCode;        // Country Code.
    public $phoneNumber;             // Phone Number.
    public $postalCode;              // ZIP Code for the contact's address.
    public $stateProvince;           // State or Province of the contact's address.
    public $title;                   // Title for the contact, such as “Mr.” or “Dr.”.
    public $userId;                  // Identifies the user account to which this contact belongs to.
