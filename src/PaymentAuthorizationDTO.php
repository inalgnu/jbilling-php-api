...
{
    public $id;                      // Unique identifier of the payment authorization.
    public $processor;               // Name of the payment processor.
    public $code1;                   // Request code number 1.
    public $code2;                   // Request code number 2.
    public $code3;                   // Request code number 3.
    public $approvalCode;            // Approval code provided by the processor.
    public $AVS;                     // A code with the results of address verification.
    public $transactionId;           // Identifier of the processor transaction.
    public $MD5;                     // Hash for the transaction.
    public $cardCode;                // Payment card code.
    public $createDate;              // The creation date for this payment authorization record.
    public $responseMessage;         // The response provided by the processor.
