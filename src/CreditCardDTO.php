...
class CreditCardDTO
{
    ...
    public $expiry;           // Expiration date of the credit card. Usually, card expiration dates are expressed in month/year form, such as “05/11” or “May 2011”. This field contains the last day the card is valid, in this example, “05/31/2011”.
    public $id;               // Unique identifier for this record.
    public $name;             // Credit card owner's name. This is the name that appears physically on the credit card.
    public $number;           // Credit card number. Usually, a 16 digit number.
    public $securityCode;     // CCV (Credit Card Verification) code of the credit card.
    public $type;             // Credit Card type. See Appendix A for acceptable values.
