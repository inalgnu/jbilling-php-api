...
{
    public $invoiceId;            // Identifier of the invoice that was generated.
    public $orderId;              // Identifier of the order that was created.
    public $paymentId;            // Identifier of the payment that was generated to pay the invoice.
    public $paymentResult;        // Outcome of the payment operation.
    public $userId;               // Identifier of the new user created and for which the order, invoice and payment were created.
