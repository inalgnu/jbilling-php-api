...
{
    public $amount;        // The total amount for this line. Usually would follow the formula price * quantity.
    ...
    public $description;   // This description will be displayed in the invoice delivered to the customer.
    public $id;            // A unique number that identifies this record.
    public $isPercentage;  // Indicates whether the item referenced by this invoice line is a percentage item or not. This is used to aid how the order line is displayed to the customer.
    public $itemId;        // Identifier of the item referenced by this invoice line.
    public $price;         // The pricing of a single unit of this item.
    public $quantity;      // The number of units of the item being invoiced.
    public $sourceUserId;  // This field is useful only when many sub-accounts is invoiced together. This field would have the ID of the user that originally purchase an item.
