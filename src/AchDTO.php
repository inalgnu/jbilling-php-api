...
class AchDTO
{
    public $abaRouting;          // ABA routing number
    public $accountName;         // The account name
    public $accountType;         // If this is chequings or a savings account.
    public $bankAccount;         // The account number
    public $bankName;            // The bank name
    public $id;                  // The unique identifier of this record.
