...
{
    public $fromStatusId;       // Status of the subscription before the transition took place. See Appendix A for acceptable values.
    public $id;                 // Unique identifier for the transition record.
    public $toStatusId;         // Status of the subscription after the transition took place.
    public $transitionDate;     // Date and time the transition took place.
    public $userId;             // Identifies the user account that suffered the subscription status change.
